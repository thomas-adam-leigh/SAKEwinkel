...
import { authQueryOptions, type AuthQueryResult } from "@/lib/auth";
...
export const Route = createRootRouteWithContext<{
  ...
  beforeLoad: ({ context }) => {
    ...
    // Update lang attribute on client-side navigation
...
function RootDocument({ children }: { readonly children: React.ReactNode }) {
  return (
    // suppress since we're updating the "dark" class in ThemeProvider and lang attribute
