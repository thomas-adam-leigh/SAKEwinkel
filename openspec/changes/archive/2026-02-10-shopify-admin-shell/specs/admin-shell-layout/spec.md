...
The top bar SHALL use a CSS grid with three columns: left (logo), center (search bar), and right (icon buttons). Items SHALL be vertically centered within the 56px height.
...
#### Scenario: Top bar center section displays search placeholder
- **WHEN** the top bar renders
